...
\section{\paperref{paper:first-paper-label}: Title of the First Paper}
\sectionmark{First Paper} % This is in case the title is too long to fit properly in the headings of the following pages

In this paper we present a method to do something. This is a reference to \paperref{paper:first-paper-label}.
...
\section{\paperref{paper:second-paper-label}: Title of the second paper}
